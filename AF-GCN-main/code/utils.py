...
def UniformSample_original_python(dataset):
    """
    the original impliment of BPR Sampling in AF-GCN
    :return:
        np.array
    """
    total_start = time()
...
def getLabel(test_data, pred_data):
    ...
    for i in range(len(test_data)):
        ...
        pred = list(map(lambda x: x in groundTrue, predictTopK))  # 得到了一个只有True或False的列表，groundTrue和predictTopK有几个值相同，就有几个True，剩下的就是False
